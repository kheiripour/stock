...
CREATE TABLE IF NOT EXISTS `daily` (
  ...
  `threeDaysLegalBuyPowerRateAve` float DEFAULT NULL,
  `threeDaysRealBuyPowerRateAve` float DEFAULT NULL,
  `yesterdayLegalBuyPowerRate` float DEFAULT NULL,
  `tomorrowRealBuyerSellerPowRate` float DEFAULT NULL,
  `volOnBasicVol` float DEFAULT NULL,
  `candleColor` tinyint(4) DEFAULT NULL,
  `candleType` tinyint(4) DEFAULT NULL,
  `threeDaysCandleTypeAve` float unsigned DEFAULT NULL,
  `closeFinalDev` float DEFAULT NULL,
  `closeMinDev` float DEFAULT NULL,
  `realBuyersVolOnVol` float DEFAULT NULL,
  `legalSellersVolOnVol` float DEFAULT NULL,
  `adPrice` int(11) unsigned DEFAULT NULL,
  `adVol` bigint(20) DEFAULT NULL,
  `fifteenAdVolAve` bigint(20) unsigned DEFAULT NULL,
  `fiveDaysLaterAdPrice` int(11) unsigned DEFAULT NULL,
  `fiveDaysLaterAdPriceDev` float DEFAULT NULL,
  `tenDaysLaterAdPrice` int(11) unsigned DEFAULT NULL,
  `tenDaysLaterAdPriceDev` float DEFAULT NULL,
  `twentyDaysLaterAdPrice` int(11) unsigned DEFAULT NULL,
  `twentyDaysLaterAdPriceDev` float DEFAULT NULL,
  `thirtyDaysLaterAdPrice` int(11) unsigned DEFAULT NULL,
  `thirtyDaysLaterAdPriceDev` float DEFAULT NULL,
  `sixtyDaysLaterAdPrice` int(11) unsigned DEFAULT NULL,
  `sixtyDaysLaterAdPriceDev` float DEFAULT NULL,
  `tomorrowAdPriceDev` float DEFAULT NULL,
  `adVolOnFifteenAdVolAve` float unsigned DEFAULT NULL,
  `yesterdayOnFourDaysBeforeAdPrice` float unsigned DEFAULT NULL,
  `createdAt` timestamp NULL DEFAULT current_timestamp(),
  `updatedAt` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `date-symbol` (`date`,`symbolid`),
  KEY `symbol` (`symbolid`)
) ENGINE=InnoDB AUTO_INCREMENT=126218 DEFAULT CHARSET=utf8mb3;
